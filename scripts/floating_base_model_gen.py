...
# q = sm.Matrix([theta_0, theta_1, theta_2, theta_3 x, z, phi])
# theta = sm.Matrix([theta_0, theta_1, theta_2, theta_3])
# dtheta_0, dtheta_1, dtheta_2, dtheta_3 dx, dz, dphi = sm.symbols('dtheta_0 dtheta_1 dtheta_2 dtheta_3 dx dz dphi')
# dq = sm.Matrix([dtheta_0, dtheta_1, dtheta_2, dtheta_3, dx, dz, dphi])
...
alpha = theta_0*v + 0.5*theta_1*v**2  + 1/3*theta_2*v**3

# --- Third order polynomial equation --- #
# alpha = theta_0*v + 0.5*theta_1*v**2  + 1/3*theta_2*v**3 + 1/4*theta_2*v**4 
...
# TODO these should probably be in static_PAC_model.py but first try moving them there had some errors so leaving for now
...
pickle.dump(fk, open("../src/acdlo/sympy_fcns/fb/fk", "wb"))
pickle.dump(fka, open("../src/acdlo/sympy_fcns/fb/fka", "wb"))
...
pickle.dump(J_end_wrt_base, open("../src/acdlo/sympy_fcns/fb/J_end_wrt_base", "wb"))
...
pickle.dump(G, open("../src/acdlo/sympy_fcns/fb/G", "wb"))
pickle.dump(Gv, open("../src/acdlo/sympy_fcns/fb/Gv", "wb"))
...
pickle.dump(B, open("../src/acdlo/sympy_fcns/fb/B", "wb"))
...
pickle.dump(C, open("../src/acdlo/sympy_fcns/fb/C", "wb"))
